...
@servicioWeb.soap('enviarApuesta', returns={'result':int},args={'listaApuestas':[{'apuesta':{'idEvento':int, 'idParticipante':int, 'montoApuesta':int, 'fechaApuesta':str, 'maquinaid':int}}]})
...
@servicioWeb.soap('verificacionToken',returns={'result':int},args={'parameter':str})
